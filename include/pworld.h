...
*/
		...
		virtual void randomValues(cyclone::Particle *particle);

		void addParticle(cyclone::Particle *particle);
...
*/
	...
	//------------------------------------------------
	 ...
	 class AllContacts : public cyclone::ParticleContactGenerator
    {
        cyclone::ParticleWorld::Particles *particles;
