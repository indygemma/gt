...
*/
    ...
    public:
		...
		//virtual cyclone::Particle* createParticle(const String& particle, const String& particleName);
...
*/
        void integrate(Ogre::Real duration);
...
* from the particle.
*/
		void setInverseMass(const Ogre::Real inverseMass);
...
*/
		Ogre::Real getInverseMass() const;
...
*/
		void setDamping(const Ogre::Real damping);
...
* the position.
*/
		void getPosition(Ogre::Vector3 *position) const;
...
* body.
*/
		void setVelocity(const Ogre::Real x, const Ogre::Real y, const Ogre::Real z);
...
*/
		void getVelocity(Ogre::Vector3 *velocity) const;
...
* body.
*/
		void setAcceleration(const Ogre::Real x, const Ogre::Real y, const Ogre::Real z);
...
*/
		void getAcceleration(Ogre::Vector3 *acceleration) const;
