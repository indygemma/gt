...
*/
Ogre::Real cyclone::sleepEpsilon = ((Ogre::Real)0.3);

/*
* Functions to change sleepEpsilon.
*/
void cyclone::setSleepEpsilon(Ogre::Real value)
{
    cyclone::sleepEpsilon = value;
}

Ogre::Real cyclone::getSleepEpsilon()
{
    return cyclone::sleepEpsilon;
}

Ogre::Real Matrix4::getDeterminant() const
{
...
void Matrix4::setInverse(const Matrix4 &m)
{
    ...
    Ogre::Real det = getDeterminant();
    if (det == 0) return;
    det = ((Ogre::Real)1.0)/det;
...
Matrix3 Matrix3::linearInterpolate(const Matrix3& a, const Matrix3& b, Ogre::Real prop)
{
    Matrix3 result;
